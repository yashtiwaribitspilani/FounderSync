...
class _ForgotPassword01WidgetState extends State<ForgotPassword01Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ForgotPassword01'});
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('FORGOT_PASSWORD01_arrow_back_rounded_ICN');
                  ...
                  if (responsiveVisibility(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'FORGOT_PASSWORD01_Row_vpolgx7q_ON_TAP');
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'FORGOT_PASSWORD01_Button-Login_ON_TAP');
