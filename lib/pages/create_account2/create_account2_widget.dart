                                      ...
                                      isAndroid
                                          ...
                                          : Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'CREATE_ACCOUNT2_CONTINUE_WITH_APPLE_BTN_');
                                                  logFirebaseEvent(
                                                      'Button_auth');
                                                  GoRouter.of(context)
                                                      .prepareAuthEvent();
                                                ...
                                                TextSpan(
                                                  ...
                                                  recognizer:
                                                      TapGestureRecognizer()
                                                        ..onTap = () async {
                                                          logFirebaseEvent(
                                                              'CREATE_ACCOUNT2_RichTextSpan_alpw56ab_ON');
                                                          logFirebaseEvent(
