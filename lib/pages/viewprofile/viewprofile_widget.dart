...
class _ViewprofileWidgetState extends State<ViewprofileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'viewprofile'});
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('VIEWPROFILE_arrow_back_rounded_ICN_ON_TA');
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          functions.textreturner(
                              _model.collapsed, widget.userdoc!.description),
                          style:
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'VIEWPROFILE_PAGE_Text_nq5g3xdz_ON_TAP');
                              ...
                              child: Text(
                                functions.showmoreless(_model.collapsed,
                      ...
                      Expanded(
                        child: wrapWithModel(
                          model: _model.tabbarswipeModel,
                          updateCallback: () => setState(() {}),
                          child: TabbarswipeWidget(
                            userviewer: widget.userdoc!.reference,
                          ),
                        ),
                      ),
                    ],
