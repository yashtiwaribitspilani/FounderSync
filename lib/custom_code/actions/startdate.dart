...
DateTime? startdate(dynamic? linkedinjson) {
  if (linkedinjson == null) {
    return null;
  }
  Experiences experiences = Experiences.fromJson(linkedinjson);
  if (experiences.startsAt == null) {
    return null;
  }
  return DateTime(experiences.startsAt!.year, experiences.startsAt!.month,
      experiences.startsAt!.day);
}
