...
import 'idea_tab_swipe_model.dart';
export 'idea_tab_swipe_model.dart';

class IdeaTabSwipeWidget extends StatefulWidget {
  const IdeaTabSwipeWidget({
    super.key,
  ...
  @override
  State<IdeaTabSwipeWidget> createState() => _IdeaTabSwipeWidgetState();
}

class _IdeaTabSwipeWidgetState extends State<IdeaTabSwipeWidget>
    with TickerProviderStateMixin {
  late IdeaTabSwipeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IdeaTabSwipeModel());
                        ...
                        children: [
                            ...
                            child: StreamBuilder<UsersRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'IDEA_TAB_SWIPE_Container_l93lsgxt_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: FlutterFlowChoiceChips(
                              options: widget.ideadoc!.currentcompetition
                          ...
                          StreamBuilder<List<IdeatimelineRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<IdeatimelineRecord>
                                  ...
                                  snapshot.data!;
                              if (listViewIdeatimelineRecordList.isEmpty) {
                              ...
                              return ListView.builder(
                                ...
                                scrollDirection: Axis.vertical,
                                itemCount:
                                    listViewIdeatimelineRecordList.length,
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return TimelineWidget(
                                    key: Key(
                                        'Keyiq9_${listViewIndex}_of_${listViewIdeatimelineRecordList.length}'),
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return CommentcardWidget(
                                    key: Key(
                                        'Key370_${listViewIndex}_of_${listViewCommentRecordList.length}'),
                                    commentdoc: listViewCommentRecord,
                                  );
                                },
                              );
                            },
