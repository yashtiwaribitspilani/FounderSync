...
import 'all_idea_card_model.dart';
export 'all_idea_card_model.dart';

class AllIdeaCardWidget extends StatefulWidget {
  const AllIdeaCardWidget({
    super.key,
  ...
  @override
  State<AllIdeaCardWidget> createState() => _AllIdeaCardWidgetState();
}

class _AllIdeaCardWidgetState extends State<AllIdeaCardWidget> {
  late AllIdeaCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllIdeaCardModel());
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        ...
        onTap: () async {
          logFirebaseEvent('ALL_IDEA_CARD_Container_kuf51cal_ON_TAP');
